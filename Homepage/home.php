        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="../Drives/index.php">UNITED GROUP OF INSTITUTIONS</a>
                </div>
        ...
        <header>
            <div class="header-content">
				...
				<h1>United Group of Institutions</h1>
                    <h1>Student Prediction System for Placement</h1>
                    <hr>
                    <p>Nurturing Talent & Skill via Innovation & Technology for Employability & Placement
                        Details</p>
