            ...
            <form action="add pdrive1.php" class="templatemo-login-form" method="POST" enctype="multipart/form-data">
			  ...
			  <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">
                  <label for="inputFirstName">Company ID</label>
                  <input type="text" name="coid" class="form-control" id="inputFirstName" placeholder="Company ID" required>
                </div>
                <div class="col-lg-6 col-md-6 form-group">
                  <label for="inputFirstName">Company Name</label>
                  <input type="text" name="compny" class="form-control" id="inputFirstName" placeholder="Company Name" required>
                </div>
			  </div>
			  <div class="row form-group">
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="inputFirstName">Tagline</label>
                  <input type="text" name="tagl" class="form-control" id="inputFirstName" placeholder="Tagline">
                </div>
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="inputFirstName">Company Type</label>
                  <input type="text" name="ctyp" class="form-control" id="inputFirstName" placeholder="Company Type">
                </div>
			  </div>
			  <div class="row form-group">
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="inputFirstName">Allocated TPO ID</label>
                  <input type="text" name="tid" class="form-control" id="inputFirstName" placeholder="TPO ID" required>
                </div>
				<div class="col-lg-6 col-md-6 form-group">
			  ...
			  <div class="row form-group">
				...
				<div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" name="contact" class="form-control" id="inputFirstName" placeholder="Contact Number">
                </div>
			  </div>
			  <div class="row form-group">                
				<div class="col-lg-6 col-md-6 form-group">
                  <label class="control-label templatemo-block">Campus/Pool</label>
                  <select name="campool" class="form-control" required>
                ...
                <div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" name="pcv" class="form-control" id="inputFirstName" placeholder="College name" required>
                </div>
			  </div>
			  <div class="row form-group">
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="sslc">10th Required Aggregate</label>
                  <input type="text" name="sslc" class="form-control" id="sslc" placeholder="%age" required>
                </div>
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="Pu">12th/Diploma Required Aggregate</label>
                  <input type="text" name="puagg" class="form-control" id="Pu" placeholder="%age" required>
                </div>
			  </div>
			  <div class="row form-group">
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="BE">B. Tech. Aggregate</label>
                  <input type="text" name="beagg" class="form-control" id="BE" placeholder="%age" required>
                </div>
                <div class="col-lg-6 col-md-6 form-group">
                  <label class="control-label templatemo-block">Current Backlogs</label>
                  <select name="curback" class="form-control" required>
