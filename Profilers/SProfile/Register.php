		...
		<div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					...
					<a href="info@united.ac.in ">info@united.ac.in </a>
				</div>
				</div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
   ...
   $connect = mysql_connect("localhost", "root", ""); // Establishing Connection with Server
  		mysql_select_db("spsp") or die("Cant Connect to database"); // Selecting Database from Server
		
		$check = mysql_query("SELECT * FROM stu_login WHERE S_id='".$USN."'") or die("Check Query");
 		if(mysql_num_rows($check) == 0) 
 		{
  			if($repassword == $password)
  			{
    			if($query = mysql_query("INSERT INTO stu_login(Name,S_id,password,email,question,answer) VALUES ('$Name','$USN','$password','$Email','$Question','$Answer')"))
    			{
