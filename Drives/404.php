				...
				<div class="top-nav">
					...
					<ul class="nav1">
						...
						<li class="hvr-sweep-to-bottom">
							...
							<li class="hvr-sweep-to-bottom">
								<a href="404.php">About<i>About Us and our Cheif Architects</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
	...
	<div class="e-page">
		...
		<div class="container">
			...
			<div class="see-button">
				<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal specialty-button e-button footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;" href="index.php" role="button">Tack Me Home</a>
			</div>
		</div>
		<!-- //container -->
	</div>
			...
			<div class="container">
				<div class="col-md-6 footer-left  wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<ul>
						...
						<li>
							<a href="404.php">Campus Drives</a>
						</li>
						<li>
							<a href="404.php">Events</a>
						</li>
						<li>
							<a href="404.php">Mail Us</a>
						</li>
					</ul>
